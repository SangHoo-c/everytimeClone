...
<html lang="en">
    ...
    <head>
        ...
        <title>강의평가</title>
        <input type="hidden" id="totalEvalCheck" value='${totalEvalCheck}' />
    ...
    <body>
        ...
        <div class="wrapper w-75">
            <div class="input-group mb-3 mx-auto">
                <input type="text" class="form-control btn-outline-dark input-sub" placeholder="과목명을 입력해주세요" />
                <a class="btn btn-outline-dark search-button" href="#" role="button"> 과목 강의평 검색 </a>
            </div>
            ...
            <div class="borderForDiv rounded-3">
                <div class="section">
                    ...
                    <c:forEach var="sub" items="${list}">
                        <article>
                            <a class="articles lecinfo" href="view?subjectNo=${sub.subjectNo }">
                                ...
                                <div class="info">
                                    <span class="semester">${sub.registerYear}-${sub.registerSemester}학기 수강자</span>
                                </div>
                                <div class="text">${sub.evalText}</div>
                            </a>
                        </article>
                    </c:forEach>
                    </div>
